...
1. 보험사업의 수익 인식이 기존의 보험료나 투자수입금 유입이 아니라, 다양한 기초 정보에 근거하여 계산 해야함. <br/>   시중의 금융변수 정보와 기업 고유데이터, 통계를 잘 쌓고 정제해서 합리적인 추정으로 미래의 보험서비스 제공에 따른 수익 인식을 해야 하므로 추정과 데이터가 중요해짐.<br/>
