...
1. 보험사업의 수익 인식이 기존의 보험료나 투자수입금 유입이 아니라, 다양한 기초 정보에 근거하여 계산 해야함. <br/>   시중의 시장금융변수정보와 기업고유데이터와 통계를 잘 쌓고 정제해서 합리적인 추정으로 미래의 보험서비스 제공에 따른 수익인식을 해야하므로 데이터가 중요해짐.<br/>
